---
title: "Tutorial (Umberto LCA+, v10.0.3.146)"
author: "Michael Rustler"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Tutorial (Umberto LCA+, v10.0.3.146)}
...
if(!"kwb.umberto" %in% installed_packages) {
  devtools::install_github("KWB-R/kwb.umberto")
}
```
...
The example .csv file (in German format, i.e. decimals are indicated with `,` 
and `;` is used as field separator) was exported from Umberto LCA+ (v.10.0.3.146) 
